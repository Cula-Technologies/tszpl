import { Box, Circle, Line, Graphic, GraphicData } from '../src/index.js';
import { createLabel } from './test-helpers.js';
import { PNG } from 'pngjs';

const testHelpers = { createLabel };

test('add box to a label', async () => {
...
test('add circle to a label', async () => {
  const label = testHelpers.createLabel();
...
test('add box overlapping circle to a label', async () => {
  const label = testHelpers.createLabel();
...
test('add lines to a label', async () => {
  const label = testHelpers.createLabel();
